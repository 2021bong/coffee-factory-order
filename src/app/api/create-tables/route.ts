...
export async function GET(request: Request) {
  ...
  //   const orderResult =
  //     await sql`CREATE TABLE CoffeeOrder_order (name varchar(20), beverage_name varchar(20), type BOOLEAN, unsweet BOOLEAN, lightly BOOLEAN)`;
  //   console.log('CoffeeOrder_status', statusResult);
  //   console.log('CoffeeOrder_order', orderResult);
